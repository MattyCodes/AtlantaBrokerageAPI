# A wrapper-module for application constants.
module Constants
  VALID_EMAIL_REGEX = 
    /^[\w+\-.]+@[a-z\d\-]+(\.[a-z\d\-]+)*\.
    (arpa|root|aero|biz|cat|com|coop|edu|gov|
    info|int|jobs|mil|mobi|museum|name|me|net|org
    |pro|tel|travel|ac|ad|ae|af|ag|ai|al|am|an|ao
    ...
    |dk|dm|do|dz|ec|ee|eg|er|es|et|eu|fi|fj|fk|fm|fo|
    fr|ga|gb|gd|ge|gf|gg|gh|gi|gl|gm|gn|gp|gq|gr|gs|gt
    |gu|gw|gy|hk|hm|hn|hr|ht|hu|id|ie|il|im|in|io|iq
    |ir|is|it|je|jm|jo|jp|ke|kg|kh|ki|km|kn|kr|kw|ky|kz
    ...
    |se|sg|sh|si|sj|sk|sl|sm|sn|so|sr|st|su|sv|sy|sz|tc
    |td|tf|tg|th|tj|tk|tl|tm|tn|to|tp|tr|tt|tv|tw|tz|ua|
    ug|uk|um|us|uy|uz|va|vc|ve|vg|vi|vn|vu|wf|ws|ye|yt|yu|za|zm|zw)$/ix
end
